...
class Add extends React.Component {
  ...
  render() {
    if (this.state.messageFromServer === "") {
      return (
        <div>
          <Button variant="outline-info" size="sm" onClick={this.openModal}>
          ...
          >
            ...
            >
              <Button variant="primary" size="sm" onClick={this.closeModal}>
          ...
          >
            <div className="button-center">
              ...
              <Link
                ...
                style={{ textDecoration: "none" }}
              >
                <Button variant="success" size="sm" onClick={this.closeModal}>
                  Close the Dialog
                </Button>
              </Link>
            </div>
